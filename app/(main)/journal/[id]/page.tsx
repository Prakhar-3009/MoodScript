...
import DeleteDialog from "./_components/delete-entry";
import EditButton from "./_components/edit-entry";
    ...
    <>
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-gray-500">
                Created {entry.createdAt ? format(new Date(entry.createdAt), "PPP") : "Unknown date"}
              </p>
            </div>
        ...
        <div className="text-sm text-gray-500 pt-4 border-t">
          Last updated {entry.updatedAt ? format(new Date(entry.updatedAt), "PPP 'at' p") : "Unknown date"}
        </div>
      </div>
    </>
  );
