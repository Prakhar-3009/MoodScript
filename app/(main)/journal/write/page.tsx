...
import { journalEntrySchema, JournalEntrySchema } from "@/lib/formschema";
...
export default function JournalEntryPage() {
  ...
  useEffect(() => {
    ...
    } else if (draftData && draftData.success && draftData.data) {
      reset({
  ...
  }, [actionResult, actionLoading, isEditMode, saveDraftFn, router]);
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    const actionData: any = {
      ...
      moodQuery: mood?.pixabayQuery ?? null,
    };
    
    if (isEditMode && editId) {
      actionData.id = editId;
    }
