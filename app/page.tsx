    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-5xl md:text-7xl lg:text-8xl gradient-title mb-6">
          Write Your Mood. <br />Discover Your Mind.
        </h1>
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Script your mood with ease. Capture your thoughts, your feelings, your story.
          Reflect on your journey — beautifully and securely.
        </p>
        ...
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold text-orange-900 mb-6">
              Start Scripting Your Journey Today
            </h2>
